...
public class MultiZoneAfView extends View {
    ...
    public MultiZoneAfView(Context context, AttributeSet attr) {
        ...
        //mScaleRatio = Float.parseFloat(SystemProperties.getString(MZAF_INDICATOR_KEY,DEFAULT_INDICATOR_RATIO));
        mScaleRatio = 1.0f;
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (mWindows != null && mWindows.length > 0) {
            ...
            // Prepare the matrix.
            Camera2Utils.prepareMatrix(mMatrix, mMirror, mDisplayOrientation, rw, rh);
